...
import { 
  ...
  UserPlus, AlertCircle, Trash2, ArrowLeft, Coins, Settings, LogOut 
} from 'lucide-react';
...
export default function ProfilePage({ session, initialFamilyMembers, householdDetails }: ProfileClientProps) {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 pb-20 flex flex-col justify-between selection:bg-teal-600 selection:text-white font-sans">
      <div className="space-y-6">
        {/* Clean Header without Redundant Save Button */}
        <header className="bg-white border-b border-slate-200/85 px-4 md:px-8 py-3.5 shadow-sm">
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              <Link href="/" className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 bg-slate-100 px-3 py-2 rounded-xl transition border border-slate-200">
                <ArrowLeft className="w-4 h-4" />
                <span>Back to Dashboard</span>
              </Link>

              {/* Auto-saving Currency Switcher (No Save Button) */}
