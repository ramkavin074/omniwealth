...
import { Lock, Sparkles, RefreshCw, LogOut, ArrowLeft, Settings, Coins } from 'lucide-react';
            ...
            <div className="flex items-center justify-between md:justify-end gap-2.5 w-full md:w-auto overflow-x-auto pb-1 md:pb-0 scrollbar-none border-t md:border-t-0 border-slate-800 pt-2 md:pt-0">
              <div className="flex items-center gap-2 shrink-0">
                ...
                <form 
                  ...
                  className="flex items-center gap-1.5 bg-slate-900 border border-slate-800 px-2.5 py-1.5 rounded-xl shrink-0 shadow-sm"
                >
