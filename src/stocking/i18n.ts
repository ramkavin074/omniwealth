...
const en: Dict = {
  ...
  'sell.voice': 'Speak the items',
  'sell.voiceListening': 'Listening…',
  'sell.voiceFail': 'Did not catch that',
  'sell.voicePerm': 'Allow the microphone to use voice',
  'sell.voiceAdded': 'Added {n} item(s)',
  'sell.voicePartial': 'Added {n} · not found: {miss}',
  'sell.basketPull': 'Customer basket',
  'sell.basketScanQr': 'Scan the QR',
  'sell.basketCode': 'Code',
  'sell.basketGet': 'Pull',
  'sell.basketBadQr': "That's not a customer basket",
  'sell.basketWrongStore': 'That basket is for another shop',
  'sell.basketNoCode': 'No basket for that code (expired or already used)',
  'sell.basketEmpty': 'Nothing to add from that basket',
  'sell.basketPaid': 'Customer says paid by UPI',
  'sell.basketPaidHint': 'Customer marked this paid by UPI — check the money landed, then complete.',
  ...
  'receipt.printerConnect': 'Connect a printer',
  'receipt.printerTest': 'Test print',
  'receipt.printerForget': 'Forget',
  'receipt.printerPaired': 'Printer paired',
  'receipt.printerFail': 'Could not reach the printer',
  'receipt.printerWeb': 'Available in the installed app only.',
  'receipt.printerHint': 'Pair once — bills then print straight to it, no dialog.',
  ...
  'rep.dead': 'Dead stock',
  'rep.reorder': 'Reorder',
  'rep.reorderNone': 'Nothing needs reordering yet',
  'rep.reorderNoSupplier': 'No supplier on record',
  'rep.reorderSend': 'WhatsApp',
  'rep.reorderLeft': '· {d}d left · ~{v}/day',
  'rep.reorderMsg': 'Reorder for {shop}:',
  'rep.weekTotal': 'Sold this week',

  'cf.title': 'Cash flow (7 days)',
  'cf.in': 'Coming in',
  'cf.out': 'Going out',
  'cf.net': 'Net',
  'cf.expected': 'Expected payments',
  'cf.none': 'Nothing due in the next 7 days',
  'cf.overdue': 'overdue',
  'cf.kind.khata': 'khata',
  'cf.kind.order': 'order',
  'cf.kind.purchase': 'supplier',
  'cf.assume': 'Assumptions',
  'cf.custDays': 'Khata paid within (days)',
  'cf.supDays': 'Pay suppliers within (days)',
  'cf.note':
    'Estimated from khata balances, open orders and unpaid purchases. Orders use their real due date; khata and suppliers use the day counts above.',
  ...
  'scan2.title': 'Customer self-scan',
  'scan2.enable': 'Let customers scan their own basket',
  'scan2.copy': 'Copy link',
  'scan2.hint':
    'Print the QR for the shop entrance. Customers scan items on their phone and hand you a QR / code at the counter — you review and bill. Needs a UPI ID set above for the "pay now" option.',
  ...
  'cust.watch': 'watch',
  'cust.watchWhy': 'Balance climbing — up {amt} over the last 60 days. Keep an eye before extending more credit.',
...
const ta: Dict = {
  ...
  'sell.voice': 'பொருட்களைச் சொல்லுங்கள்',
  'sell.voiceListening': 'கேட்கிறது…',
  'sell.voiceFail': 'புரியவில்லை',
  'sell.voicePerm': 'குரலைப் பயன்படுத்த மைக்ரோஃபோனை அனுமதிக்கவும்',
  'sell.voiceAdded': '{n} பொருள் சேர்க்கப்பட்டது',
  'sell.voicePartial': '{n} சேர்க்கப்பட்டது · கிடைக்கவில்லை: {miss}',
  'sell.basketPull': 'வாடிக்கையாளர் கூடை',
  'sell.basketScanQr': 'QR ஐ ஸ்கேன் செய்',
  'sell.basketCode': 'குறியீடு',
  'sell.basketGet': 'எடு',
  'sell.basketBadQr': 'இது வாடிக்கையாளர் கூடை அல்ல',
  'sell.basketWrongStore': 'அந்த கூடை வேறு கடைக்கானது',
  'sell.basketNoCode': 'அந்த குறியீட்டுக்கு கூடை இல்லை (காலாவधி / ஏற்கனவே பயன்படுத்தப்பட்டது)',
  'sell.basketEmpty': 'அந்த கூடையிலிருந்து சேர்க்க எதுவும் இல்லை',
  'sell.basketPaid': 'வாடிக்கையாளர் UPI-யில் செலுத்தியதாக கூறுகிறார்',
  'sell.basketPaidHint': 'வாடிக்கையாளர் இதை UPI-யில் செலுத்தியதாக குறித்துள்ளார் — பணம் வந்ததா என்று பார்த்து முடிக்கவும்.',
  ...
  'receipt.printerTest': 'சோதனை அச்சு',
  'receipt.printerForget': 'நீக்கு',
  'receipt.printerPaired': 'அச்சுப்பொறி இணைக்கப்பட்டது',
  'receipt.printerFail': 'அச்சுப்பொறியை அணுக முடியவில்லை',
  'receipt.printerWeb': 'நிறுவப்பட்ட செயலியில் மட்டும் கிடைக்கும்.',
  'receipt.printerHint': 'ஒருமுறை இணைத்தால் போதும் — பில்கள் நேரடியாக அச்சாகும்.',
  ...
  'rep.reorder': 'மறு-ஆர்டர்',
  'rep.reorderNone': 'இப்போது மறு-ஆர்டர் தேவையில்லை',
  'rep.reorderNoSupplier': 'சப்ளையர் பதிவு இல்லை',
  'rep.reorderSend': 'WhatsApp',
  'rep.reorderLeft': '· {d}நா மீதம் · ~{v}/நாள்',
  'rep.reorderMsg': '{shop} க்கான மறு-ஆர்டர்:',

  'cf.title': 'பணப் புழக்கம் (7 நாட்கள்)',
  'cf.in': 'வரவு',
  'cf.out': 'செலவு',
  'cf.net': 'நிகர',
  'cf.expected': 'எதிர்பார்க்கும் பணம்',
  'cf.none': 'அடுத்த 7 நாட்களில் எதுவும் இல்லை',
  'cf.overdue': 'தாமதம்',
  'cf.kind.khata': 'கடன்',
  'cf.kind.order': 'ஆர்டர்',
  'cf.kind.purchase': 'சப்ளையர்',
  'cf.assume': 'அனுமானங்கள்',
  'cf.custDays': 'கடன் திரும்பப் பெற (நாட்கள்)',
  'cf.supDays': 'சப்ளையருக்கு செலுத்த (நாட்கள்)',
  'cf.note':
    'கடன் இருப்பு, திறந்த ஆர்டர்கள், செலுத்தாத கொள்முதல் ஆகியவற்றிலிருந்து மதிப்பீடு. ஆர்டர்கள் அவற்றின் உண்மையான தேதியைப் பயன்படுத்தும்; கடன்/சப்ளையர் மேலே உள்ள நாட்களைப் பயன்படுத்தும்.',
  ...
  'scan2.title': 'வாடிக்கையாளர் சுய-ஸ்கேன்',
  'scan2.enable': 'வாடிக்கையாளர்கள் தங்கள் கூடையை ஸ்கேன் செய்ய அனுமதி',
  'scan2.copy': 'இணைப்பை நகலெடு',
  'scan2.hint':
    'கடை நுழைவாயிலில் QR ஐ ஒட்டவும். வாடிக்கையாளர்கள் தொலைபேசியில் பொருட்களை ஸ்கேன் செய்து கவுண்டரில் QR / குறியீடு காட்டுவார்கள் — நீங்கள் சரிபார்த்து பில் போடுங்கள். "இப்போது செலுத்து" விருப்பத்திற்கு மேலே UPI ஐடி தேவை.',
  ...
  'cust.watch': 'கவனி',
  'cust.watchWhy': 'கடன் தொகை அதிகரிக்கிறது — கடந்த 60 நாட்களில் {amt} அதிகம். மேலும் கடன் கொடுப்பதற்கு முன் கவனியுங்கள்.',
