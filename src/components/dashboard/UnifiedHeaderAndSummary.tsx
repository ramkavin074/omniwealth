        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between w-full gap-2 min-w-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className="md:hidden p-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-xl border border-slate-200 dark:border-slate-700 transition cursor-pointer disabled:opacity-50 shadow-sm shrink-0"
            >
