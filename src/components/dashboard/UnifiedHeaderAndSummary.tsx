        ...
        <div className="max-w-7xl mx-auto flex items-center gap-2 sm:gap-3 w-full">
          ...
          <div className="ml-auto flex items-center gap-1 sm:gap-1.5 shrink-0">
            ...
            <button
              ...
              className="md:hidden p-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-xl border border-slate-200 dark:border-slate-700 transition cursor-pointer disabled:opacity-50 shadow-sm"
            >
