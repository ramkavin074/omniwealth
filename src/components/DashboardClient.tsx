...
export default function DashboardClient({ 
  ...
  const selectTab = (tab: 'wealth' | 'retirement' | 'directives') => {
    if (tab !== activeTab) void haptic('light');
    setActiveTab(tab);
  };
