          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-2.5">
              ...
              <form action={async () => { window.location.href = '/login'; }}>
                <button type="submit" className="p-2 bg-slate-800 hover:bg-rose-950/60 text-slate-300 hover:text-rose-400 border border-slate-700 rounded-xl transition-colors cursor-pointer shadow-sm" title="Log Out">
